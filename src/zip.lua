...
--- @param read function A function `read(n) -> str|nil` returning a string of
--- length at most `n`, or nil if the end of the stream is reached. Typically
...
local function pack(zh, read, path, size, crc32)
    ...
    fh.size = size                  -- File size in bytes
    fh.crc32 = crc32                -- CRC-32 of the file
